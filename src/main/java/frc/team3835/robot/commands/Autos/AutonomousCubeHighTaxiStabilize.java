...
public class AutonomousCubeHighTaxiStabilize extends SequentialCommandGroup {
    ...
    public AutonomousCubeHighTaxiStabilize(ChassisSubsystem chassisSubsystem, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
        ...
        addCommands(new InstantCommand(() -> {
                    this.intakeSubsystem.setAxisPosition(Constants.ElevatorConstants.positionMap.get("Score Cube High")[1]);
                    this.elevatorSubsystem.setElevatorPosition(Constants.ElevatorConstants.positionMap.get("Score Cube High")[0]);
                }),
                new WaitCommand(3.5),
                new InstantCommand(() -> {
