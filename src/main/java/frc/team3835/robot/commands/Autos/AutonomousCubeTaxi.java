...
public class AutonomousCubeTaxi extends SequentialCommandGroup {
    ...
    public AutonomousCubeTaxi(ChassisSubsystem chassisSubsystem, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
        ...
        addCommands(new InstantCommand(() -> {
                    this.intakeSubsystem.setAxisPosition(Constants.ElevatorConstants.positionMap.get("Score Mid Cube")[1]);
                    this.elevatorSubsystem.setElevatorPosition(Constants.ElevatorConstants.positionMap.get("Score Mid Cube")[0]);
                }),
                new WaitCommand(3.5),
                new InstantCommand(() -> {
                    this.intakeSubsystem.setIntakePower(-0.58);
                }),
                new WaitCommand(0.2),
                new InstantCommand(() -> {
